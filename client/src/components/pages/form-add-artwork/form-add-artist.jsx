          ...
          <div className="form__column-two">
            <label htmlFor="form__input-category">
              ...
              <div className="form__container--input">
                <select
                  type="text"
                  id="form__input-category"
                  {...register("artworkCategory")}
                >
                  <option value=""></option>
                  {categories.map((a, b) => (
            ...
            <label htmlFor="form__input-artist">
              ...
              <div className="form__container--input">
                <select
                  type="text"
                  id="form__input-artist"
                  {...register("artworkArtist")}
                >
                  <option value=""></option>
                  {artists.map((a) => (
