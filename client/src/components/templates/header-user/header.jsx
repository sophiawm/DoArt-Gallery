  ...
  return (
    <StyledHeader>
      <header className="header">
        ...
        <div className="icons-container">
          <img
            ...
            className="icons-container__notification"
          />
          <img
            src="src/assets/icons/shopping-cart-icon.svg"
            alt="shopping-cart-icon"
            className="icons-container__shopping-cart"
          />
          <img
            src="src/assets/icons/arrow-icon.svg"
            alt="arrow-icon"
            className="icons-container__arrow"
            onClick={change}
          />
        </div>
      </header>
      ...
      <div className="dropdown__container" ref={containerDropdownRef}>
        <div className="icon-container">
          <img
            src="src/assets/icons/arrow-icon.svg"
            alt="arrow-icon"
            className="icon-container__arrow"
            onClick={changeNot}
          />
        </div>
        <div className="dropdown__text-container">
          <p className="dropdown__Home">Home</p>
          <p className="dropdown__Categories" onClick={categoriesList}>
            Categories
          </p>
          ...
          <Link className="dropdown__About-Us" to="/about-us">
            About Us
          </Link>
        ...
        <div className="dropdown__image-container">
          <img
            src="src/assets/pages/dropdown-logo.svg"
            alt="dropdown-image"
      ...
      <header className="header-desktop">
        <Link to="/react-marketplace/home">
          <img
            src="src/assets/pages/logo-DoArt.svg"
            alt="logo"
        ...
        <div className="header__container">
          <div className="container-categories">
            ...
            <ul
              className="categories__container-desktop"
              ref={containerCategoriesRefDesktop}
            >
            ...
            <img
              ...
              onClick={changeNotDesktop}
              ref={iconArrowAnimationRef}
            />
          </div>

          <Link to="/react-marketplace/about-us" className="header__about-us">
            About Us
          </Link>

          <Link
            to="/react-marketplace/login-user"
          ...
          <Link
            to="/react-marketplace/gallery-artist"
            className="header__my-profile"
          >
            Our artist
          </Link>
